...
public class BusinessDeliveryListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/jsp/business/delivery-list.jsp").forward(req, resp);
	...
	private List<Map<String, String>> getDeliveryList(String businessId, String userName, String positionName, int curPage) {
		...
		sql.append("select d.id, u.user_id,u.login_name,u.education,u.university,u.contack_num, p.title,p.address from delivery d ")
